...
Gem::Specification.new do |s|
  ...
  if ENV["RELEASING_ANYWAY"].nil? && File.directory?(File.join(__dir__, ".git"))
    s.add_runtime_dependency "ruby-next", ">= 0.11.0", "< 0.13.2"
  else
    s.add_runtime_dependency "ruby-next-core", ">= 0.11.0", "< 0.13.2"
  end
  s.add_runtime_dependency "ruby-next-parser", ">= 3.0.0.3", "< 3.1.0.0"
  s.add_runtime_dependency "parser", "< 3.0.3.0"

  s.add_development_dependency "ammeter", "~> 1.1.3"
  s.add_development_dependency "bundler", ">= 1.15"
  s.add_development_dependency "rake", ">= 13.0"
  s.add_development_dependency "rspec", ">= 3.8"
  s.add_development_dependency "ruby-next", ">= 0.8", "< 0.13.2"
